      ...
      <Section margin={false} className={`svg-background py-16 border-t border-zinc-200 dark:border-zinc-700`}>
        <Grid lg={1} className={"gap-16 lg:gap-36"}>
          <SkillDetail title="Capturing" subTitle="Capturing the best possible photographs">
            This requires a combination of technical skills and creativity. It starts with understanding the basics of
            composition, lighting, and exposure, as well as knowing how to use your camera and lenses. But it also
            involves being able to anticipate and seize the right moment, and having a keen eye for detail and
            aesthetics. It&apos;s important to be prepared for any situation and to be able to think on your feet.
            Always be open to experimentation and trying new things. And, most importantly, always be in the right
            mindset, and be willing to put in the time and effort to get the perfect shot.
          </SkillDetail>
          <SkillDetail title="Editing" subTitle="Editing is an essential and timeless process">
            Editing is necessary to achieve the best possible result in photography. It allows you to refine your
            images, correct any imperfections and enhance the overall look and feel of the photograph. It&apos;s a
            process that requires attention to detail and a good understanding of color, contrast, and tone. Whether
            you&apos;re using Lightroom, Photoshop or any other software, it&apos;s important to be familiar with the
            features and how to use them effectively. With editing, you can bring out the best in your images and make
            them truly stand out. It&apos;s an ongoing process that takes time and patience.
          </SkillDetail>
          <SkillDetail title="Your brand" subTitle="Enhance your brand image">
            Yalography offers a range of services to enhance your brand image through professional photography. Our team
            is comprised of experienced photographers, MUAs and Hair dressers that can capture stunning images that
            showcase your products, services, and brand story. We understand the importance of visual content in
            today&apos;s digital age and how it can impact the success of your business. From product photography to
            lifestyle and event photography, we have the skills and expertise to create high-quality, engaging content
            that will help your brand stand out. With Yalography&apos;s services, you can be sure that your brand image
            will be elevated to new heights and leave a lasting impression on your audience.
          </SkillDetail>
        </Grid>
      </Section>
    </>
