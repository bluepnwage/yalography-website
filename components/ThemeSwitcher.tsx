...
export function ThemeSwitcher() {
  ...
  return (
    <button
      ...
      onClick={onToggle}
      className={cx(
        `h-9 w-9 p-1 relative items-center flex justify-center rounded-md font-semibold border-2 text-center active:top-[2px]`,
        mode === "dark" ? "border-gray-200" : "border-gray-900"
      )}
    >
...
function MoonStars() {
  return (
    <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <g fill="none" stroke="rgb(17, 24, 39)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
