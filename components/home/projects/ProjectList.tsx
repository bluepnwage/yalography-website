...
const projects: ProjectProps[] = [
  { title: "Model", image: model, href: "", colSpan: "col-span-4", rowSpan: "row-span-2" },
  { title: "Wedding", image: wedding, href: "", colSpan: "col-span-4", rowSpan: "row-span-2" },
  { title: "Airport", image: airport, href: "", colSpan: "col-span-4", rowSpan: "row-span-2" },
  { title: "Pixel Art", image: pixel, href: "", colSpan: "col-span-8", rowSpan: "row-span-1" }
];
