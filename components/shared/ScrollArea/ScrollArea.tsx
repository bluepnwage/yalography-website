...
const scrollbarStyles = cva("flex bg-zinc-200 dark:bg-zinc-700 relative select-none grow touch-none", {
  variants: {
    orientation: {
  ...
  return (
    <ScrollArea.Root style={{ height }} className={`w-full overflow-hidden`}>
      ...
      <ScrollArea.Scrollbar className={scrollbarStyles({ orientation })} orientation={orientation}>
        <ScrollArea.Thumb
          className={`bg-zinc-400 dark:bg-zinc-600 w-2 grow relative rounded-md ${scrollAreaStyles.ScrollAreaThumb}`}
        />
