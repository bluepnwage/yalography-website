export function ClipboardCheck() {
  return (
    <svg height={48} width={48} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <g
        fill="none"
        className="stroke-gray-500 dark:stroke-gray-100"
        strokeLinecap="round"
...
export function ClipboardMoney() {
  return (
    <svg height={48} width={48} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <g
        fill="none"
        stroke="#ffffff"
        className="dark:stroke-gray-100 stroke-gray-500"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="2"
      >
...
export function Home() {
  return (
    <svg height="24" width="24" className="text-gray-500" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <g
        fill="none"
        className="stroke-gray-500 dark:stroke-gray-100"
        strokeLinecap="round"
...
export function Ballot() {
  return (
    <svg
      height="24"
      width="24"
      className="dark:fill-gray-100 fill-gray-500"
      viewBox="0 0 24 24"
