...
export function Copy({ className, fill, size }: PropTypes) {
  return (
    <svg
      height={size || defaultSize}
      width={size || defaultSize}
...
export function Share({ className, fill, size }: PropTypes) {
  return (
    <svg
      height={size || defaultSize}
      width={size || defaultSize}
...
export function Unlink({ className, fill, size }: PropTypes) {
  return (
    <svg
      height={size || defaultSize}
      width={size || defaultSize}
...
export function MenuIcon({ className, fill, size }: PropTypes) {
  return (
    <svg
      height={size || defaultSize}
      width={size || defaultSize}
...
export function Unpin({ className, fill, size }: PropTypes) {
  return (
    <svg
      height={size || defaultSize}
      width={size || defaultSize}
...
export function PhotoSelectLarge({ className, fill, size }: PropTypes) {
  return (
    <svg
      height={size || defaultSize}
      width={size || defaultSize}
...
export function MovieFilter({ className, fill, size }: PropTypes) {
  return (
    <svg
      height={size || defaultSize}
      width={size || defaultSize}
    ...
    >
      <g>
        <path d="M10 11l-.94 2.06L7 14l2.06.94L10 17l.94-2.06L13 14l-2.06-.94L10 11zm8.01-7l2 4h-3l-2-4h-2l2 4h-3l-2-4h-2l2 4h-3l-2-4h-1c-1.1 0-1.99.9-1.99 2l-.01 12c0 1.1.9 2 2 2h16c1.1 0 1.99-.9 1.99-2V4h-3.99zm2 14h-16V6.47L5.77 10H16l-.63 1.37L14 12l1.37.63L16 14l.63-1.37L18 12l-1.37-.63L16 10h4.01v8z" />
      </g>
    </svg>
  );
}

export function AutoFix({ className, fill, size }: PropTypes) {
  return (
    <svg
      height={size || defaultSize}
      width={size || defaultSize}
